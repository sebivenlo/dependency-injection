...
\begin{itemize}
\item makes dependencies the problems of someone different.
...
\item Open a command line and cd into 'workshop'
\item Execute './gradlew build'
\item Execute 'java -jar build/libs/gs-spring-boot-0.1.0.jar'
\end{itemize}
